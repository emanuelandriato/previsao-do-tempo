...
public class Utils {
    ...
    //public static final String API_KEY = "de0c7357d361be8987b08ef3354969bb"; chave do prof Alexandre
    ...
    public static final String URL_PREVISOES = "http://api.openweathermap.org/data/2.5/forecast/daily?q=fortaleza,brazil&mode=json&lang=pt&units=metric&cnt=14&APPID="+API_KEY;
